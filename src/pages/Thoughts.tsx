...
export default function Thoughts(): ReactElement{
    return(
        ...
        <h1 className="text-3xl font-semibold tracking-tight sm:text-xl">Thoughts</h1>
        <p className="mt-2 text-white/70">I randomly log paradigms, technologies and structural architecture concepts that I find significant.</p>
